...
describe("QuestScheduler", () => {
	...
	describe("compatibility checking", () => {
		it("should mark explicit dependencies as incompatible", () => {
			...
			const compatibility = (
				scheduler as unknown as { checkQuestCompatibility: (q1: unknown, q2: unknown) => unknown }
			).checkQuestCompatibility(quest1, quest2);
	...
	describe("quest set evaluation", () => {
		...
		it("should calculate risk level correctly", () => {
			...
			const lowRisk = (
				scheduler as unknown as { calculateSetRiskLevel: (questSet: unknown) => string }
