...
const STOP_WORDS = new Set([
	...
	"just", "also", "now", "this", "that", "these", "those", "it", "its",
]);

/** Common programming tokens to keep */
const PROGRAMMING_TOKENS = new Set([
	"function", "class", "interface", "type", "const", "let", "var",
	"async", "await", "return", "import", "export", "default", "module",
	"error", "warning", "test", "fix", "bug", "feature", "refactor",
	"update", "add", "remove", "delete", "create", "modify", "change",
	"api", "http", "get", "post", "put", "patch", "request", "response",
